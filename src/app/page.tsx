...
<div className="flex justify-end mb-4">
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-lg border border-slate-300 px-3 py-2 text-sm shadow-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex flex-1 items-center justify-center rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {submitting
                    ? "Saving..."
                    : isEditing
          ...
          <section className="w-full rounded-2xl border border-slate-200 bg-white p-6 shadow-panel lg:w-2/3">
            <div className="mb-6 flex items-center justify-between gap-4">
              <div>
                <h2 className="text-xl font-semibold text-slate-900">All Tasks</h2>
                <p className="mt-1 text-sm text-slate-500">
                  {tasks.length} task{tasks.length === 1 ? "" : "s"} in your planner
                </p>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div className="flex h-48 flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 text-center">
                    ...
                    {tasks.map((task) => (
                      <tr
                        ...
                        className={`transition hover:bg-slate-50 ${
                          currentTaskId === task.id ? "bg-blue-50/60" : ""
                        }`}
                      >
                        ...
                        <td className="px-3 py-4 align-top">
                          <span
                            className={`inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ring-1 ring-inset ${priorityBadgeClass(
                              task.priority
                            )}`}
                          >
                            {task.priority}
                        ...
                        <td className="px-3 py-4 align-top">
                          <div className="flex justify-end gap-2">
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700"
                            >
                              <PencilIcon />
                              Edit
                            </button>
